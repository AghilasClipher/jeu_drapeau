...
<html lang="fr">
  <head>
    <title>GeoGamingPro - Europe: drapeaux et pays</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta name="description" content="Apprendre et découvrir les pays et les drapeaux de l'Europe avec une carte géographique.">
    <!-- Bootstrap CSS -->
          ...
          <div class="justify-content-center" id="box_jeu">
              <div class="justify-content-center invisible" id="fin_partie_recapitulatif">
                <div class="text-center" id="fin_partie_bloc">
                  ...
                  <a class="btn btn-success" href="europe.php" role="button">Rejouer</a>
