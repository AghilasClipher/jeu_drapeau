...
//Fonction qui actualise le score en fonction de la réponse de l'utilisateur
function changer_score(){
...
function mapSetCenterZoom(){
	if(continent=='Afrique'){
		...
		map.setView(new L.LatLng(19.4326296, -99.1331785), 2);
...
function afficher_Question(pays){
	...
	$.post('ajax/recuperer_pays_geoJson.php',{pays_url_img:pays},function(data){
		img.src=data;
		img.alt="Drapeau de : "+pays;
		console.log("lurl de limage recup est: "+data);
