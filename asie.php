...
<html lang="fr">
  <head>
    <title>GeoGamingPro - Asie: drapeaux et pays</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta name="description" content="Apprendre et découvrir les pays et les drapeaux de l'Asie avec une carte géographique.">
  ...
  <body id="body_asie">
    ...
    <div class="row" id="titre_et_connexion">
      <div class="col-sm-8">
        <h1 class="display-4 titres titre_asie" id="titre_continent">Asie</h1>
      </div>
          ...
          <div class="justify-content-center" id="box_jeu">
              <div class="justify-content-center invisible" id="fin_partie_recapitulatif">
                <div class="text-center" id="fin_partie_bloc">
                  ...
                  <a class="btn btn-success" href="asie.php" role="button">Rejouer</a>
